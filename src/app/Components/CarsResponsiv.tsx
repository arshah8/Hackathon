...
export default function CarsResponsive() {
  ...
  return (
    <div className="mb-8 lg:mx-5 lg:hidden">
      ...
      <ScrollArea>
        <div className="flex space-x-4">
          {popularCars.map((car, index) => (
            <Card
              key={index}
              className="shadow-lg rounded-lg bg-blue-200 border border-blue-200 hover:shadow-xl transition duration-300 relative overflow-hidden min-w-[250px]"
            >
              <button
